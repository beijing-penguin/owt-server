...
function VMixer(rpcClient, clusterIP) {
    ...
    var addInput = function (stream_id, codec, options, avatar, on_ok, on_error) {
        ...
        if (engine) {
            ...
            if (inputId >= 0) {
                if (engine.addInput(inputId, codec, conn, avatar,"fontfile=/usr/share/fonts/gnu-free/MSYHBD.TTC:fontcolor=white:fontsize=50:x=w-tw:y=h-th:box=1:boxcolor=black@0.8:boxborderw=8:text="+arr_name[inputId])) {
