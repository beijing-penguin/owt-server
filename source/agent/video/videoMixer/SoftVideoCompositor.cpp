...
//		frame.additionalInfo.video.height = inputFrame->height();
		...
		local_m_textDrawer->setText("fontfile=/usr/share/fonts/gnu-free/MSYHBD.TTC:fontcolor=0xFF4500:fontsize=50:text='草莓泡芙卷':x=w-tw:y=h-th:box=1:boxcolor=black@0.6:boxborderw=0");
